...
class ProductServiceTest {
    ...
    void test1() {
        // given
        Long productId = 100L;
        int myprice = ProductService.MIN_MY_PRICCE + 3_000_000;
    ...
    void test2() {
        // given
        Long productId = 200L;
        int myprice = ProductService.MIN_MY_PRICCE - 50;
        ...
        // then
        assertEquals(
                "유효하지 않은 관심 가격입니다. 최소 " +ProductService.MIN_MY_PRICCE + " 원 이상으로 설정해 주세요.",
